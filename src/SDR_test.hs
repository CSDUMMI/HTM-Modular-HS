...
test_s_concate :: IO ()
test_s_concate =
  let s_1 = SDR {len=128,sdr_active_indicies=[21,23,25]}
      s_2 = SDR {len=128,sdr_active_indicies=[21,23,25]}
      s_c1_2 = SDR {len=256,sdr_active_indicies=[21,23,25,149,151,153]}
  in expect $ (s_concate s_1 s_2) `pred_compare_sdrs` s_c1_2
